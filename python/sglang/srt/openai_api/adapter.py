...
def create_streaming_usage_info(request: Request, prompt_tokens: Dict[int, int], completion_tokens: Dict[int, int]):
        ...
        async def generate_stream_resp():
            ...
            try:
                async for content in tokenizer_manager.generate_request(
                    ...
                    usage = create_streaming_usage_info(request, prompt_tokens, completion_tokens)
            ...
            try:
                async for content in tokenizer_manager.generate_request(
                    ...
                    if request.tool_choice != "none" and request.tools:
                        ...
                        create_streaming_usage_info(request, prompt_tokens, completion_tokens)
                        chunk = ChatCompletionStreamResponse(
                            id=content["meta_info"]["id"],
                            choices=[choice_data],
                            model=request.model,
